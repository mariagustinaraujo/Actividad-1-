evaluaciones = [
    ...
    # Ronda 2
    {
        ...
        'EquipoE': {'innovacion': 0, 'presentacion': 2, 'errores': False}
    },
    # Ronda 3
    {
        'EquipoA': {'innovacion': 3, 'presentacion': 2, 'errores': False},
        'EquipoB': {'innovacion': 0, 'presentacion': 1, 'errores': True},
    ...
    # Ronda 4
    {
        'EquipoA': {'innovacion': 0, 'presentacion': 2, 'errores': True},
        'EquipoB': {'innovacion': 1, 'presentacion': 1, 'errores': False},
        'EquipoC': {'innovacion': 2, 'presentacion': 1, 'errores': False},
        'EquipoD': {'innovacion': 2, 'presentacion': 2, 'errores': True},
        'EquipoE': {'innovacion': 1, 'presentacion': 2, 'errores': True}
    },
    # Ronda 5
    {
